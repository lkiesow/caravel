...
VALUES (sqlc.arg(id), sqlc.arg(trip_id), sqlc.arg(kind), sqlc.arg(storage_path), sqlc.arg(external_url), sqlc.arg(content_type), sqlc.arg(width), sqlc.arg(height), sqlc.arg(created_at))
RETURNING *;
