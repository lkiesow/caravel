    ...
    container.innerHTML = `
      <div class="document-list">
        ...
        <form class="document-form">
          ...
          <button type="submit" class="btn btn-primary btn-row">${isStaging ? `${icon("plus")} <span data-i18n="documents.stage"></span>` : `${icon("upload")} <span data-i18n="documents.upload"></span>`}</button>
        </form>
      </div>
    `;
