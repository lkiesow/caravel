...
VALUES (sqlc.arg(id), sqlc.arg(owner_id), sqlc.arg(title), sqlc.arg(start_date), sqlc.arg(end_date), sqlc.arg(subtitle), sqlc.arg(currency), sqlc.arg(created_at), sqlc.arg(updated_at))
RETURNING *;
